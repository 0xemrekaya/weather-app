...
('user@example.com', 'user', 'password123', 'user', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('admin@example.com', 'admin', 'password123', 'admin', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
